...
namespace Nekara.Core
{
    ...
    public class NekaraServer : MarshalByRefObject
    {
        ...
        [System.Runtime.InteropServices.DllImport("nekara.dll")]
        public static extern void WithoutSeed(int max_decisions);
        [System.Runtime.InteropServices.DllImport("nekara.dll")]
        public static extern void WithSeed(int _seed, int max_decisions);
        ...
        public string InitializeTestSession(JObject arg)
        {
            ...
            // New Changes:
            WithSeed(sessionInfo.schedulingSeed, sessionInfo.maxDecisions);
