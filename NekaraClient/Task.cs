...
namespace Nekara.Models
{
    ...
    public class TaskCompletionSource<TResult>
    {
        ...
        private static readonly NekaraClient _Client = RuntimeEnvironment.Client;
        ...
        public Task task
        {
            get
            {
                int taskId = _Client.TaskIdGenerator.Generate();
                int resourceId = _Client.ResourceIdGenerator.Generate();
